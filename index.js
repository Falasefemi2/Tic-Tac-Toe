...
const playerWon = () => {
    if (spaces[0] === currentPlayer) {
        if (spaces[1] === currentPlayer && spaces[2] === currentPlayer) {
            strategy.innerText = `${currentPlayer} wins on the top`;
            return true;
        }
    ...
    if (spaces[4] === currentPlayer) {
        if (spaces[1] === currentPlayer && spaces[7] === currentPlayer) {
            strategy.innerText = `${currentPlayer} wins on the vertically`;
            return true;
        }
        if (spaces[3] === currentPlayer && spaces[5]) {
            strategy.innerText =`${currentPlayer} wins on the horizontally on the middle`;
            return true;
        }
